...
## Simulation vs Reality <a href="#simulation-vs-reality" id="simulation-vs-reality"></a>
...
## The second defense - Payment only on a sell transaction <a href="#the-second-defense-payment-only-on-a-sell-transaction" id="the-second-defense-payment-only-on-a-sell-transaction"></a>
...
## From Victim to Predator <a href="#from-victim-to-predator" id="from-victim-to-predator"></a>
