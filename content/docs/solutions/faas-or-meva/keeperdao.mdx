...
---
<br/>
## <img src="/images/icon-offense-faas.png" alt="" width="32" height="32" style={{display: 'inline-block', verticalAlign: 'middle', marginRight: '0.25rem'}} />KeeperDAO
...
### The Hiding Game <a href="#the-hiding-game" id="the-hiding-game"></a>
...
### Here's the ELI5 <a href="#heres-the-eli5" id="heres-the-eli5"></a>
...
### kCompound (Phase 2 of the Hiding Game) <a href="#kcompound-phase-2-of-the-hiding-game" id="kcompound-phase-2-of-the-hiding-game"></a>
