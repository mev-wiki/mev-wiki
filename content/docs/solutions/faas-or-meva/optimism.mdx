...
## <img src="/images/icon-offense-faas.png" alt="" width="32" height="32" style={{display: 'inline-block', verticalAlign: 'middle', marginRight: '0.25rem'}} />Optimism
...
![MEVA on Ethereum](/images/diagram-meva-ethereum.png)

### Implementing the Auction <a href="#implementing-the-auction" id="implementing-the-auction"></a>
...
### Block producers - Transaction Inclusion <a href="#block-producers-transaction-inclusion" id="block-producers-transaction-inclusion"></a>
...
### Sequencers - Transaction Ordering <a href="#sequencers-transaction-ordering" id="sequencers-transaction-ordering"></a>
...
### Implementation on Layer 2 <a href="#implementation-on-layer-2" id="implementation-on-layer-2"></a>
