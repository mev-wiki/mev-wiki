---
title: Conveyor (Automata Network)
---

## <img src="/images/icon-defense-shield.png" alt="" width="32" height="32" style={{display: 'inline-block', verticalAlign: 'middle', marginRight: '0.25rem'}} />Conveyor - The Automata Network approach to tackling MEV
...
![](/images/diagram-conveyor-automata.png)
...
#### Why should users trust Conveyor? <a href="#why-should-users-trust-conveyor" id="why-should-users-trust-conveyor"></a>
...
#### An industry-first: Oblivious RAM <a href="#an-industry-first-oblivious-ram" id="an-industry-first-oblivious-ram"></a>
