---
title: Fair sequencing service (Chainlink)
---

## <img src="/images/icon-defense-shield.png" alt="" width="32" height="32" style={{display: 'inline-block', verticalAlign: 'middle', marginRight: '0.25rem'}} />The Fair Sequencing Service by ChainLink
